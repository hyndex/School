        ...
        return (
            <div>
                <div className="form-group row">
                    ...
                    <div className="col-8">
                        <input id="type" name="type" key='type' onChange={this.handleChange} placeholder="Role" type="text" required="required" className="form-control" />
                    </div>
                </div>
                <div className="form-group row">
...
export class PutForm extends React.Component {
    ...
    Update = (e) => {
        e.preventDefault()
        fetch('http://' + SERVER_URL + '/api/stafftype/' + this.props.select._id + '/', {
            method: 'PUT',
            credentials: 'include',
        ...
        return (
            <div>
                <div className="form-group row">
                    <label htmlFor="role" className="col-4 col-form-label">Add Staff Type</label>
                    <div className="col-8">
                        <input id="type" name="type" key='type' onChange={this.handleChange} defaultValue={this.props.select.type} type="text" required="required" className="form-control" />
                    </div>
                </div>
                <div className="form-group row">
                    <div className="offset-4 col-8">
